			...
			if (user) {
				...
				Firebase.firestore()
					...
					.then((querySnapshot) => {
						...
						this.setState({ isAdmin: admin, isLoading: false, name: user.displayName });
					})
							...
							<Menu.Item>
								...
								<Accordion.Content active={this.state.activeIndex === 0}>
									<Transition animation="browse" visible={!this.state.activeIndex} duration={500}>
										{/* <a href="/mess-extras">Mess Extra</a> */}
									</Transition>
									<Transition animation="browse" visible={!this.state.activeIndex} duration={500}>
						...
						<Accordion as={Menu} vertical>
							<Menu.Item>
								...
								<Accordion.Content active={this.state.activeIndex2 === 0}>
									...
									<Transition animation="browse" visible={!this.state.activeIndex2} duration={500}>
										<a href="/sports">Sports, Music, Gym</a>
									</Transition>
								</Accordion.Content>
							</Menu.Item>
						</Accordion>
				...
				<Navbar.Collapse id="basic-navbar-nav">
					<Nav className="mr-auto nav_items">
						...
						<NavDropdown className="nav_hide" title="Facilities" id="basic-nav-dropdown">
							...
							<NavDropdown.Item href="/sports">Sports, Gym & Music</NavDropdown.Item>
						</NavDropdown>
						...
						{!this.state.isLogin ? (
							...
							<>
							<Nav.Link className="login" onClick={this.signOut}>
								Logout
							</Nav.Link>
							<Nav.Link className="name" href="/profile">
